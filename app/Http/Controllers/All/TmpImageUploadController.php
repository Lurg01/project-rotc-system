        ...
        if($request->hasFile('image') || $request->hasFile('avatar') || $request->hasFile('documents')) 
        {
            ...
            if(is_array($request->image)) 
            {
                ...
                foreach($images as $img): 
                    ...
                    $img->storePubliclyAs('tmp', $img_file_name , 'public');  // store on the default disk ( storage > app > public)
            ...
            else if(is_array($request->documents))
            {
                    ...
                    foreach($documents as $doc): 
                        ...
                        $doc->storePubliclyAs('tmp', $doc_file_name , 'public');  // store on the default disk ( storage > app > public)
            ...
            else
            {
                ...
                $image->storePubliclyAs('tmp', $image_name, 'public'); // store to the default storage driver temporarily
