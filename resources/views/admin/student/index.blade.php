    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn float-end btn_add_category btn-primary" onclick="save()">Submit</button>
                <button data-dismiss="modal" type="button" class="btn float-end btn_update_category btn-primary" onclick="">Close</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid py-4">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <button class="float-right btn btn-sm btn-primary me-3" data-toggle="modal" data-target="#a_semester">Create
                        Student +</button>
