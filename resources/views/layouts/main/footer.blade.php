        ...
        <div class="row">
            ...
            <div class="col-md-4 pt-5">
                ...
                <ul class="list-unstyled text-white footer-link-list">
                    <li class="text-white">
                        ...
                        Sample Address, Philippines
                    </li>
                    <li>
                        <i class="fa fa-phone"></i>
                        <a class="text-decoration-none text-white" href="tel:+639683127111">+639683127111</a>
                    </li>
                    <li>
                        <i class="fa fa-envelope"></i>
                        <a class="text-decoration-none text-white" href="mailto: app.email@gmail.com">
                            app.email@gmail.com</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-4 pt-5">
                ...
                <ul class="list-unstyled footer-link-list">
                    <li>
                        <a class="text-decoration-none text-white" href="javascript:void(0)">Service One</a>
                    </li>

                    <li>
                        <a class="text-decoration-none text-white" href="javascript:void(0)">Service Two</a>
                    </li>

                    <li>
                        <a class="text-decoration-none text-white" href="javascript:void(0)">Service Three</a>
                    </li>
            ...
            <div class="col-md-4 pt-5">
                ...
                <ul class="list-unstyled text-white footer-link-list">
                    ...
                    <li><a class="text-decoration-none text-white" href="/">About Us</a>
                    </li>
                    <li><a class="text-decoration-none text-white" href="/">Services</a>
                    </li>
                    <li><a class="text-decoration-none text-white"
                            href="https://bdbwardrobe.mainsandbox.com/frequently-asked-question">FAQS</a></li>
