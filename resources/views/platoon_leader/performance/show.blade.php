...
@section('content')
    ...
    <div class="container-fluid mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('platoon_leader.performances.index') }}">All Record
                    </a>
                </li>
                <li class="breadcrumb-item">
                    <a href="{{ route('platoon_leader.students.show', $performance->student) }}">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($performances as $other_performance)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="text-muted"
                                                    href="{{ route('platoon_leader.performances.show', $other_performance) }}">
